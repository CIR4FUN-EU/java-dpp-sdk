...
if ERRORLEVEL 1 (
echo. >&2
echo Error: Java was not found in your environment. >&2
...
echo Warning: JAVA_HOME is set to an invalid directory. >&2
echo JAVA_HOME = "%JAVA_HOME%" >&2
echo Falling back to java on PATH. >&2
where java >NUL 2>NUL
if ERRORLEVEL 1 (
echo. >&2
echo Error: Java was not found in your environment. >&2
