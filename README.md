...
- `dpp-sdk-demo`: runnable mock repository service, runnable mock registry service, integration demo, Docker runtime, Postman collections, and demo guides.
...
docker compose -f dpp-sdk-demo/docker-compose.build.yml --env-file dpp-sdk-demo/.env up --build    # Build the images and start the demo services
```
